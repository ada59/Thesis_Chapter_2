################################################################################
# Script to generate figures 2.1 & 2.2
...
# This is code available online by Milos Popovic May 14, 2022

# NOTE: this code was run on the St Andrews BioTIME server & figures were
# downloaded.
...
country_elevation_df21 <- get_elevation_data(country_transformedMexico) # Figure 2.1
country_elevation_df22 <- get_elevation_data(country_transformedTT)     # Figure 2.2
...
#load("country_elevation_df22.RData")
...
#plotpath <- "C:/Users/afe1/OneDrive - University of St Andrews/PHD/0_GLOBAL_THESIS_CHAPTER_GITHUB_REPOSITORIES/Chapter2/Plots"
...
# bc the prev won't save the Cropped version:
